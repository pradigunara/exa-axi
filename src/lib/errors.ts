...
const patterns: { pattern: RegExp; code: string; message: (m: RegExpMatchArray) => string; suggestions: (m: RegExpMatchArray) => string[] }[] = [
  {
...
export function mapApiError(error: unknown): AxiError {
